...
<h1 class="wp-block-heading has-text-align-center" style="font-size:32px;font-style:normal;font-weight:700"><?php echo esc_html__( 'Blog', 'villavista' ); ?></h1>
<!-- /wp:heading --></div></main>
<!-- /wp:cover -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"right":"0","left":"0","top":"0","bottom":"var:preset|spacing|20"}}},"backgroundColor":"secondary","className":"post-block","layout":{"type":"default"}} -->
<div class="wp-block-group post-block has-secondary-background-color has-background" style="padding-top:0;padding-right:0;padding-bottom:var(--wp--preset--spacing--20);padding-left:0"><!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"default"}} -->
<div class="wp-block-group"><!-- wp:post-featured-image {"isLink":true,"width":"100%","height":"350px","style":{"border":{"radius":"0px"},"spacing":{"margin":{"top":"0","bottom":"0","left":"0","right":"0"}}}} /-->
...
<!-- wp:post-excerpt {"moreText":"Read More","excerptLength":60} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<p class="has-text-align-center"><?php echo esc_html__( 'No posts found', 'villavista' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:template-part {"slug":"sidebar"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></main>
<!-- /wp:group -->