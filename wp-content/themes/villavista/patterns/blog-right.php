...
<h1 class="wp-block-heading has-text-align-center" style="font-size:32px;font-style:normal;font-weight:700"><?php echo esc_html__( 'Blog Right Sidebar', 'villavista' ); ?></h1>
<!-- /wp:heading --></div></main>
<!-- /wp:cover -->
...
<div class="wp-block-group"><!-- wp:post-featured-image {"isLink":true,"height":"350px","style":{"border":{"radius":"0px"},"spacing":{"margin":{"top":"0","bottom":"0","left":"0","right":"0"}}}} /-->
